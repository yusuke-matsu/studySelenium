...
public class sayHelp {
  ...
  @Test
  public void testSayHelp() throws Exception {
    //access to slack
	driver.get(baseUrl);
    ...
    driver.findElement(By.id("msg_form")).sendKeys("@adam_bot2 help");
